...
public class adminInput extends JFrame implements ActionListener {
	...
	public void OneToPoster() {
		...
		dto.setAdminSubject(subject);
		dto.setAdminContent(content);
		...
		if (content.equals("") || subject.equals("")) {
			...
			int cnt = dao.admin(dto,num.getNum());
